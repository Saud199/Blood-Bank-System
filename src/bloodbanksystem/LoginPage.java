...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/app_logo_1.png"))); // NOI18N
        ...
        jLabel3.setText("Don't have an Account yet? Create Account");
        ...
        jButton2.setText("Visit as Guest");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (email.length()==0 || pass.length()==0) {
            ...
            try {
                /* counting the no of users in DB */
                ...
                if (emptycount==0) {
                    ...
                    while (rs1.next()) {
                        ...
                        pwd_chk = rs1.getString("u_pass");
                        bGroup = rs1.getString("bloodgroup");
                        mobNo = rs1.getString("u_mobileno");
                
                        if (!email_chk.equalsIgnoreCase(email) && !pwd_chk.equals(pass)) {
                            errorMsg.setText("Account doesn't exist");
                        }
                        
                        else if (email_chk.equalsIgnoreCase(email) && !pwd_chk.equals(pass)) {
                            errorMsg.setText("Invalid Password");
                        }
                        
                        
                        else if (email_chk.equalsIgnoreCase(email) && pwd_chk.equals(pass)) {
                            UserDetails.id = rs1.getString("u_id");
                            UserDetails.name = rs1.getString("u_name");
                            UserDetails.bloodGroup = rs1.getString("bloodgroup");
                            UserDetails.mobileNo = rs1.getString("u_mobileno");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        dispose();
        GuestAfterLogin gAL = new GuestAfterLogin();
